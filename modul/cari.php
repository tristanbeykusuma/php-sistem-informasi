...
<button onclick="location.href = 'http://digital-dental-record.herokuapp.com/php-sistem-informasi/latihan.php';" id="myButton" class="float-left submit-button" >Home</button>
